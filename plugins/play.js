...
⬡ Upload: ${publishedTime}
⬡ Link: ${vid.url}
╰────────⬣`, author.trim(), await( await conn.getFile(thumbnail)).data, ['ᴠɪᴅᴇᴏ', `${usedPrefix}getvid ${url} 360`], false, { quoted: m, 'document': { 'url':'https://tiktok.com/@greenteabot' },
...
body: wm,
sourceUrl: 'https://tiktok.com/@greenteabot', thumbnail: await ( await conn.getFile(thumbnail)).data
  }
 } 
})
